...
\begin{equation}
    ...
    \xi_i(k+1) =\xi_i(k)-\left(\displaystyle \sum_{j \in N_i}a_{ij} + d_i \right) \phi_i(k)\Delta u_i(k) + \displaystyle \sum_{j \in N_i}a_{ij} \Delta y_j(k) + d_i \Delta y_d(k+1)
\end{equation}
...
\begin{equation}
    ...
    \Delta u_{i,\text{SM}}^M = \frac{\omega \hat{\phi}_i(k)}{\sigma + \hat{\phi}_i(k)^2}\left(\frac{\alpha(\displaystyle \sum_{j \in N_i}a_{ij} y_j(k) + d_i y_d(k+1))-\xi_i(k)}{\alpha(\displaystyle \sum_{j \in N_i}a_{ij}+d_i)} - y_i(k)
    \right)
\end{equation}
