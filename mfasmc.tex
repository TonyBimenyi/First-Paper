...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{var_tracking.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{var_error.png}
    \caption{Distributed measurement errors.}
