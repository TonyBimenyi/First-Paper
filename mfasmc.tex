...
Remark 1: Assumption 1 provides a general condition for controller design, while assumption 2 ensures that the bounded changes in control input result in the bounded changes in output energy rates, supporting system stability and performance.
...
Remark 2: The CFDL technique does not contain any prior knowledge about the system dynamic model. Moreover, the dynamic behavior of time-varying PPD can be highly complex and more challenging to verify. Therefore a data-driven methodology to study numerical characteristics becomes the prefered solution.
