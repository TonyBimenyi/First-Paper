...
\begin{thebibliography}{99}
    ...
    \bibitem{ren2005}
    W. Ren, R. W. Beard, and E. M. Atkins, "A survey of consensus problems in multi-agent coordination," \textit{Proceedings of the American Control Conference}, pp. 1859-1864, 2005.
    
    \bibitem{cao2013}
    Y. Cao, W. Yu, W. Ren, and G. Chen, "An overview of recent progress in the study of distributed multi-agent coordination," \textit{IEEE Transactions on Industrial Informatics}, vol. 9, no. 1, pp. 427-438, 2013.
    ...
    Zhou, N (Zhou, Ning) [1] ; Deng, WX (Deng, Wenxiang) [1] ; Yang, XW (Yang, Xiaowei) [1] ; Yao, JY (Yao, Jianyong) [1] , "Continuous adaptive integral recursive terminal sliding mode control for DC motors." ,\textit{International Journal of Control}, vol. 96, no. 9, pp.2190-2200, June 2022
    \
