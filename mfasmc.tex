...
Example 1: The desired reference tajectory is:
...
As shown in Fig. \ref{fig:error_inv} and \ref{fig:error_var}, the distributed errors for all agents are relatively small and converge to zero over time.
