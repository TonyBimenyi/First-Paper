...
Remark 1:The above assumptions are general and aligned with reality. Assumption 1 specifies the constraints of the controller. Assumption 2 ensures that changes in the input rate limited, thereby restricting the rate change in the output, which is satisfied in real industrial systems.
