...
Lemma 1\cite{8}: Consider agents with dynamic (\ref{model 1}) satisfying above two assumptions. If $ | \Delta u_i(k) | \neq 0 $ holds, then the system (\ref{model 1}) can be transformed into a compact form dynamic linearization (CFDL) data model as follow:
...
Let denote the following distributed measurement error of \(\xi_i(k)\) for $N$ agents:
