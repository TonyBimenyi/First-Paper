...
% \noindent 
where $u_i(k) \in \mathbb{R}$ and $y_i(k) \in \mathbb{R}$ are the system input signal and output signal at instant $ k $, respectively, while $f_i(\cdot)$ is an unknown nonlinear function.
