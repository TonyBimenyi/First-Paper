...
In this equation \(\xi_i(k)\) represents the distributed measurement output of the $i$th agent at time step k , \(N_i\) denotes the set of the neighboring agents of the $i$th agent and \(a_{ij}\) are elemnents of the adjancecy matrix representing the weights between agents \(i\) and \(j\).   
